'''### 1. Given the following URL, identify:'''
...
# f. Identify the port > This URL does not contain a port, most URLs use default port that is 443
...
# a. Identify the query parameters >> there are no query parameters
